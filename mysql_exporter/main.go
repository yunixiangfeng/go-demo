...
func initConfig() *config.ExporterConfig {
	...
	return &config.ExporterConfig{
		Web: &config.WebConfig{
			Addr: ":9999",
			Auth: &config.AuthConfig{"wu123", "2f64f20f7ecd620286e3cd1f6f821122"},
		},
	}
}
...
func main() {
	...
	addr := ":9999"
	mysqlAddr := "192.168.204.130:3306"
	dsn := "root:1234@tcp(192.168.204.130:3306)/mysql?charset=utf8mb4&loc=PRC&parseTime=true"
